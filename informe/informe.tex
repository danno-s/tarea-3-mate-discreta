...
\section{Solución}
	El juego fue programado en \verb!Python 2.7!, usando las librerías \verb!pygame! y \verb!PyOpenGL!. Además se usaron algunas funciones del paquete \verb!pygltoolbox! creado por Pablo Pizarro R. Para almacenar las constantes del juego se utilizaron archivos \verb!.json!. Los archivos \verb!.py! principales son:
	\begin{itemize}
		\item \verb!edgey.py!:
